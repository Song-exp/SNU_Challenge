...
DATA_DIR = '../input/datasets/leebyeongcheol/snu-ai-challenge-data/snuaichallenge_data/'
TRAIN_IMAGE_DIR = os.path.join(DATA_DIR, 'train')

# 업로드하신 stratified_valid.csv 경로를 지정하세요!
